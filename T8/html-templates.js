...
function fileList( files, d){
    ...
    pagHTML += `
          ...
          <div class="w3-container w3-teal" style="text-align: center;">
              <address>Generated by PG42816::T8::DAW2020 em ${d}</address>
          </div>
      </body>
      </html>
    `
    ...
    <html>
        ...
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <div id="newFiles"></div>
                <input class="w3-btn w3-blue-grey" type="button" onclick="newFile()" value="Add File"/>
                <input class="w3-btn w3-light-green" type="submit" value="Submit"/>

                </form>

            <footer class="w3-container w3-teal" style="text-align: center;">
                <address>Gerado por PG42816::T8::DAW2020 em ${d} || <a href="/">Voltar</a></address>
            </footer>
        </body>
    </html>
    `
