...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="ARQELEM" mode="indice">
        ...
        <li>
            ...
            <a href="{count(preceding-sibling::*)+1}.html">
            ...
            <html>
                ...
                <body>
                    ...
                    <div class="addr" style="text-align:center; padding-bottom: 20px;">
                        <!-- <address>[<a href="/arqs/#i{count(preceding-sibling::*)+1}">Home</a>]</address> -->
                        <address>[<a href="http://localhost:7777/">Home</a>]</address>
                    </div>
